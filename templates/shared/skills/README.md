...
| `core-review` | Whole-repo pre-review (before a PR / before pushing review fixes) run as a read-only pass — inline or via `@agent-core-review` on Copilot/Codex, optionally a subagent on Claude Code — to preempt Copilot iterations |
